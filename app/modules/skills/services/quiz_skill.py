...
class QuizSkill(BaseSkill):
    ...
    async def run(self, request: SkillRequest) -> SkillResult:
        ...
        nb_questions = min(params.get("nb_questions", 10), 20)  # max 20
        type_quiz = params.get("type_quiz", "qcm")  # qcm|qro|vrai_faux|mixte
        ...
        {{
          ...
          "questions": [
            {{
              ...
              "options": ["A", "B", "C", "D"],  // pour qcm/qro
              "bonne_reponse": "A",  // ou la réponse exacte pour vrai_faux
        ...
        for attempt in range(max_retries):
            result = await self.llm_generer(
                ...
                temperature=0.7,  # Un peu de créativité pour les questions
